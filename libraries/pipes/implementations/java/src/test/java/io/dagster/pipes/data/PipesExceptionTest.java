...
class PipesExceptionTest {
    ...
    void testClose() {
        ...
        Assertions.assertTrue(message.startsWith(
            "{\"__dagster_pipes_version\":\"0.1\",\"method\":\"closed\","
                + "\"params\":{\"exception\":{\"name\":\"java.lang.Exception\","
                + "\"message\":\"Exception message\",\"cause\":{\"name\":\"java.lang.Exception\","
                + "\"message\":\"Inner exception\",\"cause\":null,\"stack\":null,\"context\":[]},\"stack\":["
        ));
    }
